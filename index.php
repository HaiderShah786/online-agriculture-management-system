...
<html lang="en">
	...
	$query = $conn->query("SELECT * FROM website_settings limit 1")->fetch_array();
  ...
  background-color: #dee2e6;
    ...
    <body id="page-top">
        <!-- Navigation-->
        <div class="toast" id="alert_toast" role="alert" aria-live="assertive" aria-atomic="false">
        <div class="toast-body text-red">
        </div>
      </div>
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                <a class="navbar-brand2 js-scroll-trigger" href="./"><?php echo $_SESSION['setting_name'] ?></a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
					...
					<?php if(isset($_SESSION['login_user_id'])): ?>
						...
						<li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=contact">Contact Us</a></li>
						 ...
						 <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=upload_product"><span>  <i class="fa fa-shopping-cart"></i>  </span>Upload Products</a></li>
  ...
  <div class="modal fade" id="uni_modal_right" role='dialog'>
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="light-gray-bg py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © 2024 - Online Agriculture Management System | <a href="" target="_blank">Syed Haider Shah</a></div></div>
        </footer>
